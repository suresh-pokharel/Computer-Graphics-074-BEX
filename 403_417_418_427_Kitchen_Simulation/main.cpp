...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(Renderer::w_width, Renderer::w_height, "ROOM model", nullptr, nullptr);
    if (!window)
    {
    ...
    // model Loading
    Model chair("res/objects/Pawan/Chair.obj");
    Model table("res/objects/Pawan/Table.obj");
    Model wall("res/objects/Pawan/Wall.obj");
    Model windows("res/objects/Pawan/Windows.obj");
    // Model glass("res/objects/Pawan/Chair.obj");
